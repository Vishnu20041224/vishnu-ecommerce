...
import { Pencil, Trash, Loader2, Circle, Package, ShoppingCart, ArrowBigRightDash, ArrowBigLeftDash } from 'lucide-react';
                ...
                <div className="flex gap-4 ">
                  {Object.entries(product.collectionsImgs).map(([color, images]) => (
                    ...
                    <div className="flex md:gap-10 md:px-10 gap-3 px-3">
                        <button className="flex-1/2 bg-yellow-400 font-semibold md:text-lg text-base border border-yellow-700 hover:bg-yellow-200 hover:text-yellow-700 cursor-pointer md:py-2.5 md:px-3.5 py-3 px-3  rounded-md text-white flex gap-2 items-center justify-center">Edit<Pencil /></button>
                        {/* <button  className="flex-1/2 bg-red-400 font-semibold md:text-lg text-base border border-red-700 hover:bg-red-200 hover:text-red-700 cursor-pointer md:py-2.5 md:px-3.5 py-3 px-3  rounded-md text-white transition-transform flex gap-2 items-center justify-center">Delete<Trash /></button> */}
                        <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    want to delete {product.ditails}
                                </AlertDialogDescription>
                            </AlertDialogHeader>
